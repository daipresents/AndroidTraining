...
public class GetAsyncTaskLoader extends AsyncTaskLoader<String> {
    ...
    private static final String YOUTUBE_URL = "http://gdata.youtube.com/feeds/api/standardfeeds/JP/top_rated?time=today";

    public GetAsyncTaskLoader(Context context) {
        super(context);
    }
    ...
    public String loadInBackground() {
        ...
        try {
            ...
            Log.v(MainActivity.class.getSimpleName(), YOUTUBE_URL);
